#!/usr/bin/env sh
# Universal installer for graphqlmap. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/graphqlmap.git"
