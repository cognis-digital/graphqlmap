...
[![PyPI](https://img.shields.io/pypi/v/cognis-graphqlmap.svg)](https://pypi.org/project/cognis-graphqlmap/)
[![CI](https://github.com/cognis-digital/graphqlmap/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/graphqlmap/actions)
...
GRAPHQLMAP exists for one job — analyze graphql introspection for risky fields, depth, and authz gaps — and does it without a SaaS bill or heavyweight setup.
...
```bash
graphqlmap --version
graphqlmap scan .                      # scan the current project
graphqlmap scan . --format json
graphqlmap scan . --fail-on high       # non-zero exit for CI gates
graphqlmap mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **graphql-cop**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`graphqlmap` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
