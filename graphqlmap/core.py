"""GRAPHQLMAP core — Analyze GraphQL introspection for risky fields, depth, and authz gaps."""
...
RULES = [
    ("GRA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("GRA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("GRA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
