"""Native cognis-connect emit for graphqlmap — forward findings to any platform.

Maps graphqlmap's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    graphqlmap ... --format json | graphqlmap-emit --to stix
    graphqlmap-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
